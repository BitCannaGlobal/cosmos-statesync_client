...
BINARY="https://github.com/BitCannaGlobal/bcna/releases/download/v3.0.0-rc3/bcna_darwin_arm64.tar.gz"
...
then
  ...
  rm -f bcna_darwin_arm64.tar.gz #delete old file if exist
  wget -nc $BINARY
