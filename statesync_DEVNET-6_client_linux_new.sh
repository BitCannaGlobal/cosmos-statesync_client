...
#     [state-sync]
#     snapshot-interval = 1000. ; 10 FOR DEVNET-6 TESTNET 
...
BINARY="https://github.com/BitCannaGlobal/bcna/releases/download/v1.5.3/bcna_darwin_arm64.tar.gz"
GENESIS="https://raw.githubusercontent.com/BitCannaGlobal/testnet-bcna-cosmos/main/instructions/bitcanna-dev-6/genesis.json"
APP="BCNA: ~/.bcna"
echo ".....DEVNET-6 use only........"
echo "=============================="
...
then
  ...
  chmod +x bcnad
  ./bcnad init New_peer --chain-id bitcanna-devnet-6
  ...
  echo ##################################################################
  sleep 5
  ./bcnad config chain-id bitcanna-dev-6
  ./bcnad start
